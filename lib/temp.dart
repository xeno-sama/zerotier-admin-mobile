...
//                         UserLoaded(members: final members) => ListView.builder(
//                             itemCount: members
//                                 .where(
//                                   (user) => user.name
//                                       .toLowerCase()
...
//                                   )
//                                   .toList()[index];
//                               // AuthStatus.authorized => user.authorized AuthStatus.unauthorized => !user.authorized
//                               // activityStatus => user.lastSeen for last 1 hour
//                               return Card(
//                                 child: ExpansionTile(
//                                   shape: const Border(),
...
//                 mainAxisSize: MainAxisSize.min,
//                 children: [
//                   // Text(l10n.addUserManuallyByNodeID),
//                   // TextField(
//                   //   controller: nodeIdController,
//                   //   focusNode: nodeIdFocus,
//                   //   minLines: 1,
//                   //   // maxLines: null,
//                   //   decoration: InputDecoration(
...
//                   //       ),
//                   //     ),
//                   //     suffixIcon: nodeIdFocus.hasFocus
//                   //         ? IconButton(
//                   //             icon: Icon(
//                   //               Icons.cancel,
//                   //               color: theme.colorScheme.error,
//                   //             ),
//                   //             onPressed: nodeIdController.clear,
//                   //           )
//                   //         : null,
//                   //   ),
//                   // ),
